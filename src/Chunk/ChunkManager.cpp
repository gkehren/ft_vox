                                      ...
                                      GpuResourceRetire &retire, MeshArenas &arenas, const Camera &camera, int budget)
{
	...
	// Performance: Avoid dynamic heap allocations for hash nodes in hot frame loops.
	// We use thread_local std::vector combined with linear search (std::find) for
	// O(1) cache-friendly contiguous access, outperforming unordered_set for small bounded sizes.
