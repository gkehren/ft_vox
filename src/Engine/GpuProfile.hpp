...
enum class GpuPass : uint32_t { Frame, Upload, Shadow, Opaque, Overlays, Water, Sky, Post, Ssao, Exposure, ImGui, Mobs, MobShadow0, MobShadow1, MobShadow2, Count };
...
inline constexpr std::array<const char *, kGpuPassCount> kGpuPassNames = {
    "GPU Frame", "Uploads", "Shadow", "Opaque", "Overlays", "Water", "Sky", "Post", "SSAO", "Exposure", "ImGui", "Mobs", "Mob shadow 0", "Mob shadow 1", "Mob shadow 2"};
