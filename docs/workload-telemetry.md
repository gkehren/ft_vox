...
| `column.bytes`, `occupancy.bytes` | Inline biome/color/height arrays and the per-section occupancy counters (issue #105: 32 B per chunk, replacing the former 8 KiB bitset), including free chunks |
